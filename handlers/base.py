...
async def cmd_rules(message: Message):
    ...
    rules_html = (
        ...
        "<b>Сбор билетов</b> автоматически прекращается, как только набрано <b>2500 билетов</b> или <b>10 апреля 2026</b>.\n\n"
        "После остановки сбора:\n"
        "❌ играть и оплачивать нельзя\n"
        "✅ можно посмотреть свои билеты, лидерборд и правила\n\n"
        "Розыгрыш проводится честно среди всех выданных билетов через <a href='https://www.random.org/'>random.org</a>.\n\n"
