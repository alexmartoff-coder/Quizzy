...
async def cmd_rules(message: Message):
    ...
    rules_html = (
        ...
        "<b>Сбор билетов</b> автоматически прекращается, как только набрано <b>2500 билетов</b> или 10 апреля 2026.\n\n"
...
async def cmd_my_tickets(message: Message):
    ...
    if not tickets:
        await message.answer("У тебя пока нет билетов. Нажми «🎁 Играть в Квиз за iPhone 17» в меню, чтобы участвовать!")
    else:
