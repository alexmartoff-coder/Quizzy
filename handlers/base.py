...
async def cmd_rules(message: Message):
    ...
    rules_html = (
        ...
        "<b>Сбор билетов</b> автоматически прекращается, как только набрано <b>2500 билетов</b> или наступит <b>10 апреля 2026 года</b>.\n\n"
        ...
        "Победитель будет выбран путём https://www.random.org/\n\n"
